...
public class BalanceSheetService {
    ...
    public void updateBalanceSheet(Group group, Expense expense) {
        ...
        // Synchronizing on the specific group block instance guarantees that internal map allocations
        // across totalPaid, totalExpense, and user balances occur inside a single atomic sequence.
        synchronized (group) {
